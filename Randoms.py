...
print('int  ---  ceil --- floor --- half_up --- half_down')
print(trunc_II(12.5, 0), '---', round_up(12.5, 0), '---', round_down(12.5, 0), '---', round_half_up(12.5, 0), '---', round_half_down(12.5, 0))
print(trunc_II(-5.87, 1), '---', round_up(-5.87, 1), '---', round_down(-5.87, 1), '---', round_half_up(-5.87, 1), '---', round_half_down(-5.87, 1))
print(trunc_II(1.625, 2), '---', round_up(1.625, 2), '---', round_down(1.625, 2), '---', round_half_up(1.625, 2), '---', round_half_down(1.625, 2))
print(trunc_II(-127.4, -1), '---', round_up(-127.4, -1), '---', round_down(-127.4, -1), '---', round_half_up(-127.4, -1), '---', round_half_down(-127.4, -1))
print(trunc_II(127.9, -1), '---', round_up(127.9, -1), '---', round_down(127.9, -1), '---', round_half_up(127.9, -1), '---', round_half_down(127.9, -1))
